...
const groups: string[][] = [
  ...
  [
    ...
    "Nine cycles. Thirteen dreams per cycle. The thirteenth is what comes after completion:",
    "the new perception, the new reality. You don't know what you'll get. Neither does she. That's the point.",
  ],
  [
  ...
  return (
    <div>
      <section className="page-padding section-spacing pb-20 md:pb-32">
        <FadeInView>
          <div
            className="max-w-2xl mx-auto text-editorial-body text-foreground text-left"
